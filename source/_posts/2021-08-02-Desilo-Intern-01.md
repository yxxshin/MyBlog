...
회사 출입 카드를 받고, 자리를 배정 받고, 한 명씩 인사를 드릴 때는 이 곳에서 내가 4달 간 일하게 될 것이 전혀 실감이 나지 않았다. 회사의 모든 사람들이 나에게 너무나 친절했고, 재밌는 사람들이었다 :D 그렇게 데스크탑을 받고, Linux 설치 + 세팅을 이틀 간 진행하면서(...) 본격적으로 나의 첫 인턴이 시작되었다.
